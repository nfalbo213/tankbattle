            ...
            if (tanTankPosition[i].y <= darkTankPosition[n].y + 40 && tanTankPosition[i].y >= darkTankPosition[n].y - 40 && darkTankPosition[n].facingLeft === false) {
                ...
                if (!darkTankPosition[n].boss) {
                    ...
                    if (darkTankPosition[n].roundFiredIndex === 0 || darkTankPosition[n].roundFiredIndex === 2) {
                        ...
                        battlefield_ctx.drawImage(muzzleFire, darkTankPosition[n].x + 78, darkTankPosition[n].y + 8, muzzleFire.width + 2, muzzleFire.height + 2);
                    }
                }
            ...
            if (tanTankPosition[i].y <= darkTankPosition[n].y + 40 && tanTankPosition[i].y >= darkTankPosition[n].y - 40 && darkTankPosition[n].facingLeft === true) {
                ...
                if (!darkTankPosition[n].boss) {
                    ...
                    if (darkTankPosition[n].roundFiredIndex === 0 || darkTankPosition[n].roundFiredIndex === 2) {
                        ...
                        battlefield_ctx.drawImage(muzzleFire, darkTankPosition[n].x - 16.5, darkTankPosition[n].y + 8.5, muzzleFire.width + 2, muzzleFire.height + 2);
                    }
                }
                if (darkTankPosition[n].roundFiredIndex === 3) {
                    darkTankPosition[n].roundFiredIndex = 0;
...
startMenuTouch.onpointerdown = (event) => {
...
leftOptionMouse.onmousedown = (event) => {
...
leftOptionTouch.onpointerdown = (event) => {
...
rightOptionTouch.onpointerdown = (event) => {
...
fireButton.onpointerdown = (event) => {
    event.preventDefault();
...
leftButton.onpointerdown = (event) => {
   event.preventDefault(); 
   if (startObj.gameStart && !startObj.startClicked && !startObj.gameOver) {
...
rightButton.onpointerdown = (event) => {
   event.preventDefault(); 
   if (startObj.gameStart && !startObj.startClicked && !startObj.gameOver) {
...
downButton.onpointerdown = (event) => {
   event.preventDefault(); 
   if (startObj.gameStart && !startObj.startClicked && !startObj.gameOver) {
